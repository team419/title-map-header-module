...
const TitleRight = (props) => {
  ...
  return (
    <div className={css['title-right']}>
      ...
      <button type="button" className={`${css['btn-text']} ${css['btn-photo']}`}>
        <svg role="img" className={`${css['icon-svg']} ${css['svg-generic']} ${css['svg-add-img']}`} viewBox="0 0 18 18">
      ...
      <button type="button" className={`${css['btn-text']} ${css['btn-share']}`} onClick={toggleModalShare}>
        <svg role="img" className={`${css['icon-svg']} ${css['svg-generic']} ${css['svg-share']}`} viewBox="0 0 18 18">
      ...
      {/* need refactor for reusable toggleModal */}
      <button type="button" className={`${css['btn-text']} ${css['btn-save']}`} onClick={toggleModalSave}>
        <svg role="img" className={`${css['icon-svg']} ${css['svg-generic']} ${css['svg-save']}`} viewBox="0 0 14 14">
