...
const TitleRight = (props) => {
  ...
  return (
    <div className={css.title} id="title-right">
      <button type="button" id="btn-review">
        <svg role="img" className={`${css['icon-svg']} ${css['svg-generic']}`} id="svg-star" viewBox="0 0 24 24">
      ...
      <button type="button" className={css['btn-text']} id="btn-photo">
        <svg role="img" className={`${css['icon-svg']} ${css['svg-generic']}`} id="svg-add-img" viewBox="0 0 18 18">
      ...
      <button type="button" className={css['btn-text']} id="btn-share" onClick={toggleModalShare}>
        <svg role="img" className={`${css['icon-svg']} ${css['svg-generic']}`} id="svg-share" viewBox="0 0 18 18">
      ...
      {/* need refactor for reusable toggleModal */}
      <button type="button" className={css['btn-text']} id="btn-save" onClick={toggleModalSave}>
        <svg role="img" className={`${css['icon-svg']} ${css['svg-generic']}`} id="svg-save" viewBox="0 0 14 14">
